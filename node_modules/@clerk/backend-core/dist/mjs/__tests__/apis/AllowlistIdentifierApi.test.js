...
test('createAllowlistIdentifier() creates an allowlist identifier', async () => {
    ...
    expect(allowlistIdentifier).toEqual(new AllowlistIdentifier({
        id: resJSON.id,
        identifier,
...
test('deleteAllowlistIdentifier() throws an error without allowlist identifier ID', async () => {
    await expect(TestBackendAPIClient.allowlistIdentifiers.deleteAllowlistIdentifier('')).rejects.toThrow('A valid ID is required.');
});
